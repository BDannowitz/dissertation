...
\red{Start with overview: define scope, production, monitoring, merging, analysis. Then talk philosophy.}
...
\red{Add pros/cons. Discuss motivation.}
...
\red{Talk about dataQuality bits, the levels they're used at, and how to use them in selecting data.}

\section{Discussion}

\subsection{Retrospective on Scalability}
