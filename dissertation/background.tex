...
\begin{figure}
	...
	\caption{The DIS per-nucleon cross section ratio of gold to deuterium at SLAC\cite{Hen:2013oha}. Overlaid is the na\:{i}ve, expected ratio taking into account only the Fermi motion of the nucleons in the gold nucleus.}
