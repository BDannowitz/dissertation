...
\red{Show resolution in x2, mass via tracked MC vs truth residuals.}
...
\red{Segueway to decoding in Chapter so and so where all of these data files are handled.}