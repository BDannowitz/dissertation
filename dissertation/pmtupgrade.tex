...
\begin{figure}[b]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/pmtupgrade/MOSFET_Structure.png}
...
Along with this confirmation, the amplitude output by the PMT signals was above the minimum threshold of the discriminators being used. As a result, the noisy amplifier modules were able to be removed from the signal pipeline, and thereby reduced the amount of false hits due to electronic noise.