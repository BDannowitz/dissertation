...
\section{Beam Dump and Hadron Absorbers}
...
is the water-cooled beam dump whose upstream face is located at $z = 0$m. The beam dump is made of one of the many solid iron 5m blocks that fill and surround the area around the FMAG coils. The whole length of the beam dump along the beam axis is equivalent to $\approx35$ nuclear interaction lengths of iron. 

Between the downstream face of FMAG and Station 1, there is a 2 cm thick wall of borated polyethylene. This relatively thin layer of polyethylene interacts with and slows down fast neutrons down to thermal energies. It is thus used as a neutron shielding material in areas of low and intermediate neutron flux close to the target and beam dump region.

Farther downstream, there is another hadron absorber wall located between Station 3 and Station 4. The absorber wall consists of 98cm thick iron. This is an equivalent of $\approx6$ nuclear interaction lengths The purpose of this wall is to identify muons at the rear of the apparatus by effectively blocking all other types of particles. The only particles which can penetrate this absorber wall are muons.
